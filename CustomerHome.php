...
<body>
                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="CustomerViewPlan.php">View Plan</a></li>
                            
                            <li><a href="CustomerAddFeedback.php">Feedback</a></li>
                            
                            <li class="nav-right-sty mt-lg-0 mt-sm-4 mt-3">
                                <a href="index.html" class="reqe-button text-uppercase">Logout</a>
    ...
    <div class="cpy-right text-center">
        <p class="text-bl">© 2019 Splendid Spaces. All rights reserved | Design by
