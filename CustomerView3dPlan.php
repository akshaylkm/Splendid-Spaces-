...
<div class="col-md-9 product-model-sec">
	...
	session_start();
					$res=mysql_query("SELECT * FROM 3dfront");
	  				while($data=mysql_fetch_assoc($res))
					{
						...
						$g = $data['plan'];
						echo "
					 <a href='3DFront/$g'><div class='product-grid love-grid'>
						<div class='more-product'><span> </span></div>						
						<div class='product-img b-link-stripe b-animate-go  thickbox'>
							<img src='3DFront/$g' class='img-responsive' alt='' style ='height='600px' width='337px''/>
							<div class='b-wrapper'>
	...
	if(isset($_REQUEST['b1']))
	{
		$id = $_SESSION['cid'];
		$c = $_REQUEST['pid'];
		$qry= "insert into 3d_cust_order values('','$c','$id','Booked')";
		mysql_query($qry);
