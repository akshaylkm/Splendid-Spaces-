...
if(move_uploaded_file ($file_path,'Readymade/'.$file_name))//"images" is just a folder name here we will load the file.
					  		
					  		
					  					  $qry="insert into readymadeplan(planname,plotsize,dimension,floor,bedroom,plan) values('$name','$cname','$address','$pincode','$gender','$file_name')";
					//  echo "saved";
